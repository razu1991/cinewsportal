                ...
                <form class="form-horizontal" action="<?php echo base_url(); ?>super_admin/save_news" method="post" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="tag_id">
                                    ...
                                    <?php
                                    foreach ($all_published_tag as $v_tag) {
                                        ?>
                                        <option value="<?php echo $v_tag->tag_id; ?>"><?php echo $v_tag->tag_name; ?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea class="cleditor" name="news_summary" id="textarea2" rows="2"></textarea>
                            </div>
                            <br><br>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="textarea2">Mid Section News</label>
                                <div class="controls">
                                    <select name="mid_news">
                                        <option>Select status..</option>
                                        <option value="1">Yes</option>
                                        <option value="0">No</option>
                                    </select>
                            ...
                            <div class="control-group">
                                <label class="control-label" for="textarea2">Front Desk News</label>
                                <div class="controls">
                                    <select name="desk_news">
                                        <option>Select status..</option>
                                        <option value="1">Yes</option>
                                        <option value="0">No</option>
                                    </select>
